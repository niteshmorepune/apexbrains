    ...
    <div class="space-y-3" x-data="{ open: 'students' }">
        ...
        <div class="bg-white rounded-xl border border-border overflow-hidden">
            ...
            <div x-show="open === 'certs'" x-collapse class="border-t border-border px-6 pb-5 pt-4 space-y-3 text-sm text-text-muted">
                <p><span class="font-semibold text-gray-700">Generate a Level Up certificate:</span> Certificates → fill <strong>Select Student</strong>, <strong>Certificate Level</strong> (defaults to "Auto" — the student's current level — or pick any completed level), <strong>Issue Date</strong>, and <strong>Certificate Series</strong>. This page only issues the <strong>Level Up</strong> type. The right panel shows a <em>live preview</em> of the real certificate artwork.</p>
                <p class="text-xs text-gray-400">Note: a Level Up certificate can only be generated once the student has <strong>passed the level-up exam</strong> for the selected level, and only once per student/level (revoke the existing one first to reissue).</p>
                <p><span class="font-semibold text-gray-700">Other certificate types are issued elsewhere, automatically:</span> <strong>Participation</strong> certificates are issued the moment a student submits a competition attempt — no action needed. <strong>Champion</strong> (rank 1–3) and <strong>Winner</strong> (rank 4–6) certificates are bulk-generated per level from <strong>Competitions → [competition] → Results</strong>, once results are declared.</p>
                ...
                <p><span class="font-semibold text-gray-700">PDF &amp; verification:</span> the PDF is a clean branded certificate with a QR code that links to a public verification page. Students can view and download their own certificates from their portal, and get an in-app notification the moment any certificate is issued to them.</p>
