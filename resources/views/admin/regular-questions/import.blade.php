...
@section('title', 'Import Regular Question Bank')
@section('page-title', 'Import Regular Question Bank')
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2 space-y-4">
        <div class="bg-white rounded-2xl border border-border p-6">
            ...
            <p class="text-xs text-gray-500 mb-4">
                Category and Type are read directly from the file — questions are never tied to a Level.
            </p>

            <form method="POST" action="{{ route('admin.regular-questions.import.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mt-5 flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.regular-questions.import.template') }}"
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-2xl border border-border p-5">
            ...
            <ul class="space-y-2 text-xs text-gray-500">
                <li class="flex gap-2"><span class="text-fran font-bold">•</span> An unknown category or type is a skipped row — nothing is auto-created.</li>
                <li class="flex gap-2"><span class="text-fran font-bold">•</span> No level column — Levels only gain access via the Regular Practice Configuration.</li>
