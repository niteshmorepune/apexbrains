    ...
    <div class="space-y-3" x-data="{ open: 'practice' }">
        ...
        <div class="bg-white rounded-2xl border border-border overflow-hidden">
            ...
            <div x-show="open === 'notifications'" x-collapse class="border-t border-border px-5 pb-5 pt-4 space-y-2 text-sm text-text-muted">
                ...
                <p>You'll get a notification whenever a new competition opens for registration, a competition you took declares its results, or a certificate is issued to you.</p>
            </div>
        </div>
