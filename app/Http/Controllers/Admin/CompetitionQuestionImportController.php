...
use App\Imports\CompetitionQuestionBankImport;
...
class CompetitionQuestionImportController extends Controller
{
    public function index(): View
    {
        return view('admin.competition-questions.import');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $import = new CompetitionQuestionBankImport();
        ...
        AuditLogger::log('competition_questions_imported', 'CompetitionQuestionBank', null);
        ...
        return redirect()->route('admin.competition-questions.index')
